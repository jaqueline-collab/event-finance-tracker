...
export const mapPlanoToDb = (p: Plano) => ({
  ...
  valor_acompanhamento: p.valorAcompanhamento ?? 0,
  permite_modulos_opcionais: p.permiteModulosOpcionais ?? true,
  ativo: p.ativo ?? true,
...
export const mapDbToPlano = (r: any): Plano => {
  ...
  return ({
    ...
    permiteModulosOpcionais: r.permite_modulos_opcionais == null ? true : Boolean(r.permite_modulos_opcionais),
...
export const mapClienteToDb = (c: Cliente) => ({
  ...
  status_comercial: c.statusComercial ?? "ativo",
...
export const mapDbToCliente = (r: any): Cliente => ({
  ...
  statusComercial: r.status_comercial === "trial" ? "trial" : "ativo",
