...
function movimentoToDb(mov: Movimento) {
  return {
    ...
    vigencia_plano: mov.vigenciaPlano || null,
    cobranca_troca: mov.cobrancaTroca || null,
    apps: mov.apps || null,
    mau: mov.mau || null,
  ...
  persist(
    (set, get) => ({
      ...
      atualizarMauFechamentoItem: async (itemId, mauMes) => {
        ...
        const valorContatosExc = plano?.valorContatosExc ?? plano?.valorCanaisExc ?? 0.095;
