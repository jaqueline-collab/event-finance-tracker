...
Bug de navegação: ao clicar em "Sair da visualização" no modo "Ver como cliente", o sistema está redirecionando para `/perfil` (Meu perfil) em vez de voltar para o Dashboard (`/dashboard`) do EloraCRM.  

  Corrija para que "Sair da visualização" sempre leve de volta ao Dashboard, não para o perfil do usuário.